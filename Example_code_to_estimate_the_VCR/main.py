...
'''
This is a simple example code to estimate the VCR from a nonlinear time series
'''
...
plt.plot(pred[:,sp], color = 'r', label = 'Forecast')
plt.legend()
...
#%% Jacobian coefficients and the volume contraction rate
...
corr_matrix_of_jacobian = fn.inference_quality(jacobians, true_jacobian_matrix)
plt.figure()
sns.heatmap(corr_matrix_of_jacobian, annot = True)
